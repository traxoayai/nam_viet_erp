...
export const PolicyProductModal: React.FC<Props> = ({ open, onCancel, onSelect }) => {
        ...
        { 
            ...
            render: (_: any, r: any) => (
                <Space direction="vertical" size={0}>
                     ...
                     {r.items_per_carton > 1 && <span style={{fontSize: 10, color: '#888'}}>1 Thùng = {r.items_per_carton} Lẻ</span>}
                </Space>
            )
        },
    ];
