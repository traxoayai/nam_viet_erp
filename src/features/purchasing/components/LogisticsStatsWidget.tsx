...
import { CarOutlined, RocketOutlined, HomeOutlined, InboxOutlined } from '@ant-design/icons';
...
export const LogisticsStatsWidget: React.FC<LogisticsStatsWidgetProps> = React.memo(({ stats }) => {
