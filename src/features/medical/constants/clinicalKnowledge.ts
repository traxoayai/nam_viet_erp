...
export const CLINICAL_RED_FLAGS = {
    ...
    CV: {
        ...
        tags: [
            ...
            { id: 'cv_2', label: 'Tiền sử nhồi máu cơ tim / Đột quỵ', isDanger: true },
...
export const VACCINATION_SCREENING = [
    {
        id: 'vac_1',
        question: 'Có tiền sử sốc hoặc phản ứng nặng sau lần tiêm chủng trước không?',
    ...
    {
        id: 'vac_3',
        question: 'Đang dùng thuốc suy giảm miễn dịch (Corticoid liều cao, xạ trị) không?',
