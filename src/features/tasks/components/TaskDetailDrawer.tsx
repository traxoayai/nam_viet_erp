...
export const TaskDetailDrawer: React.FC<Props> = ({
  ...
  return (
    <Drawer
      ...
      extra={
        <Space>
          <Tag color="cyan" className="text-sm px-3 py-1 rounded-full">
    ...
    >
      <div className="flex items-center gap-4 mb-6 bg-gray-50/80 p-5 rounded-2xl border border-gray-100">
        <Avatar size="large" src={task.assignee_avatar}>
        ...
        <div>
          ...
          <div className="font-semibold text-gray-800 text-lg">
            {task.assignee_name || "Đang cập nhật"}
          </div>
        </div>
      </div>
      ...
      {isAssigner && task.status !== "done" ? (
        <div className="mt-8 border-t border-gray-100 pt-6 text-center">
          <Button
            ...
            className="w-full h-14 rounded-2xl text-lg font-medium shadow-lg bg-green-500 hover:bg-green-600 border-none"
          >
