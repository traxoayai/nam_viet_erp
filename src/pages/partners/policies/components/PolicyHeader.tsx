  ...
  return (
    <Card title="Thông tin chung" size="small" style={{ marginBottom: 16 }}>
      <Row gutter={16}>
        ...
        <Col span={6}>
           <Form.Item name="range_picker" label="Thời gian hiệu lực" rules={[{ required: true }]}>
        ...
        <Col span={24}>
             <Form.Item name="attachment_url" label="Link tệp đính kèm">
                 <Input prefix={<UploadOutlined />} placeholder="Dán link Google Drive hoặc URL tài liệu..." />
             </Form.Item>
        </Col>
      </Row>
    </Card>
