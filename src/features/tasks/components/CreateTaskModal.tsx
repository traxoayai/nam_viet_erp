...
export const CreateTaskModal: React.FC<Props> = ({ open, onClose }) => {
  ...
  return (
    <Modal
      title={
        <h3 className="text-xl font-bold text-gray-800 m-0">Giao Việc Mới</h3>
      }
      open={open}
      onCancel={onClose}
      onOk={() => form.submit()}
    ...
    >
      ...
      >
        <Form.Item
          name="title"
          label={
            <span className="font-semibold text-gray-700">Tên công việc</span>
          }
        ...
        <Form.Item
          name="assignee_id"
          label={
            <span className="font-semibold text-gray-700">Người nhận việc</span>
          }
