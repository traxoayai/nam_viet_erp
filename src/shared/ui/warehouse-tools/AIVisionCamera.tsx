...
export const AIVisionCamera = ({ visible, onClose, onResult }: AIVisionCameraProps) => {
  ...
  const startCamera = async () => {
    ...
    try {
      ...
      console.error(err);
      setErrorMsg("Không thể truy cập Camera. Vui lòng kiểm tra quyền hoặc dùng HTTPS.");
    }
  };
  ...
  return (
    <Modal
      ...
      bodyStyle={{ padding: 0, background: "#000", height: "80vh", position: "relative", overflow: "hidden" }}
    >
        {/* Nút đóng */}
        ...
        <div style={{ width: "100%", height: "100%", display: "flex", justifyContent: "center", alignItems: "center" }}>
            {errorMsg ? (
                <div style={{ color: "white", padding: 20, textAlign: "center" }}>
                   <p>{errorMsg}</p>
                   <Button onClick={startCamera} icon={<RefreshCw size={16}/>}>Thử lại</Button>
                </div>
            ) : (
                <video 
                   ref={videoRef} 
        ...
        {!errorMsg && (
            <div style={{
                ...
                <div style={{ position: "absolute", top: -30, width: "100%", textAlign: "center", color: "#fff" }}>
        ...
        <div style={{ position: "absolute", bottom: 40, width: "100%", textAlign: "center", zIndex: 10 }}>
            <Spin spinning={scanning} tip="Đang phân tích...">
                <Button 
                   ...
                   shape="circle" 
                   size="large" 
                   style={{ width: 72, height: 72, background: "#fff", border: "4px solid rgba(0,0,0,0.2)" }}
