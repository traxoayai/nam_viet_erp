...
export const PosPaymentSection = () => {
  ...
  useEffect(() => {
     if (!amountGiven && totals.grandTotal > 0) setAmountGiven(totals.grandTotal);
  }, [totals.grandTotal]);
  ...
  return (
    <Card size="small" title="Thanh Toán" style={{ flex: 1 }}>
       ...
       <Row justify="space-between" align="middle">
          <Title level={4} style={{ margin: 0, color: '#0050b3' }}>KHÁCH TRẢ:</Title>
       ...
       <div style={{ marginTop: 16, background: '#f5f5f5', padding: 12, borderRadius: 8 }}>
          ...
          <div style={{ marginTop: 8, display: 'flex', justifyContent: 'space-between' }}>
             <Text>Tiền thừa:</Text>
             <Text strong style={{ color: change < 0 ? 'red' : 'green', fontSize: 16 }}>
