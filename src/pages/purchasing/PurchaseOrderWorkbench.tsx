...
const PurchaseOrderWorkbench: React.FC = () => {
  ...
  const [isUpdatePriceModalVisible, setUpdatePriceModalVisible] =
    useState(false);
      ...
      render: (text: string, record: unknown) => (
        <Space>
          {record.product_image ? (
            <img src={record.product_image} alt="pic" width={40} />
          ) : null}
          <div>
    ...
    >
        ...
        >
          <Col>
            <Space>
              ...
              <Tag color={poStatus === "DRAFT" ? "default" : "blue"}>
                {poStatus}
              </Tag>
            </Space>
          </Col>
                  ...
                  <Form.Item label="Hình thức giao hàng" name="shipping_method">
                    <Select
                      options={[
                        ...
                        { label: "Lấy tại kho", value: "PICKUP" },
                      ]}
                      placeholder="Chọn"
                    />
                  </Form.Item>
          ...
          <Col xs={24} lg={8}>
            <Space direction="vertical" style={{ width: "100%" }} size="middle">
              ...
              <Card title="Hợp đồng & Chiết khấu" size="small">
                <Form.Item
                  label="Chương trình CK"
                  name="supplier_program_id"
        ...
        <Card title="Danh sách sản phẩm" size="small" style={{ marginTop: 16 }}>
          <div style={{ marginBottom: 16 }}>
            <DebounceProductSelect
              ...
              onChange={handleSelectProduct as unknown}
          ...
          <Form.List name="items">
            {() => {
              ...
              return (
                <Table
                  dataSource={items.map((it: unknown, i: number) => ({
                    ...it,
                    key: i,
                  }))}
                  columns={columns}
      ...
      */}
      ...
      <Modal
        ...
        onCancel={() => setUpdatePriceModalVisible(false)}
