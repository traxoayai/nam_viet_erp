...
const LogisticsStatsWidgetComponent: React.FC<LogisticsStatsWidgetProps> = ({
  stats,
}) => {
...
LogisticsStatsWidgetComponent.displayName = "LogisticsStatsWidget";

export const LogisticsStatsWidget = React.memo(LogisticsStatsWidgetComponent);
