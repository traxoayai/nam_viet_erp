        ...
        BEGIN
            ...
            base_query AS (
                SELECT 
                    ...
                    -- [LOGIC MỚI] Tính % Tiến độ nhập kho
                    CASE 
    ...
    COMMENT ON FUNCTION "public"."get_purchase_orders_master"("p_page" integer, "p_page_size" integer, "p_search" "text", "p_status_delivery" "text", "p_status_payment" "text", "p_date_from" timestamp with time zone, "p_date_to" timestamp with time zone) IS 'Danh sách Đơn mua hàng (Admin View) với Tiến độ nhập kho Dynamic';
