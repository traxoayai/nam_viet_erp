...
import { SaveOutlined, PrinterOutlined, CalendarOutlined, SendOutlined } from '@ant-design/icons';
...
export const DoctorBlock5_Actions: React.FC<Props> = ({ onSave, onPrint, onScheduleFollowUp, loading }) => {
                ...
                <Popover
                    ...
                    content={
                        <div className="flex gap-2">
                            ...
                            />
                            <Button type="primary" onClick={handleCreateAppointment}>Hẹn</Button>
                        </div>
                    }
                >
                    <Button 
